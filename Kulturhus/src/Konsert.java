...
Filen inneholder klassen Konsert.*/

import java.io.*;
import java.time.*;
import javax.swing.*;

//Klassen er en subklasse av klassen UnderholdningsArrangement og implementerer Serializable. Dette er en klasse for alle konserter
public class Konsert extends UnderholdningsArrangement implements Serializable
{
    /*Metoden er konstruktøren til klassen Konsert. Paramtrenes betydning:
